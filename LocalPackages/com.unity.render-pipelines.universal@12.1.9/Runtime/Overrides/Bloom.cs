...
namespace UnityEngine.Rendering.Universal
{
    ...
    public sealed class Bloom : VolumeComponent, IPostProcessComponent
    {
        ...
        [Tooltip("出现光晕的饱和度的阈值")]
        public ClampedFloatParameter saturationThreshold = new ClampedFloatParameter(1,0f, 1f);
        
        [Tooltip("饱和度影响bloom的强度")]
        public MinFloatParameter saturationIntensity= new MinFloatParameter(0,0f);
        ...
        [Tooltip("Bloom Fast")]
        public BoolParameter bloomFast = new BoolParameter(false);
