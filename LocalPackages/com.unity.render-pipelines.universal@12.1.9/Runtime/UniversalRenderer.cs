...
namespace UnityEngine.Rendering.Universal
{
    ...
    public sealed class UniversalRenderer : ScriptableRenderer
    {
        ...
        CopyColorPass m_CopyColorPassAfterTrans;
...
#endif
        CustomShadowCasterPass m_CustomShadowCasterPass;
        ...
        RenderTargetHandle m_OpaqueAndTransparentColor;
        ...
        public UniversalRenderer(UniversalRendererData data) : base(data)
        {
            ...
            m_CustomShadowCasterPass = new CustomShadowCasterPass(RenderPassEvent.BeforeRenderingShadows);
            ...
            //在渲染完半透明队列后增加一个copycolorPass 
            m_CopyColorPassAfterTrans = new CopyColorPass(RenderPassEvent.AfterRenderingTransparents, m_SamplingMaterial, m_BlitMaterial);
            ...
            m_OpaqueAndTransparentColor.Init("_CameraOpaqueAndTransparentTexture");
        ...
        protected override void Dispose(bool disposing)
        {
            ...
            m_CustomShadowCasterPass.OnPassDestroy();
        ...
        public override void Setup(ScriptableRenderContext context, ref RenderingData renderingData)
        {
            ...
            bool customShadows = m_CustomShadowCasterPass.Setup(context, ref renderingData);
            ...
            //bool copyColorPassAfterTrans = renderingData.cameraData
            ...
            if (customShadows)
                EnqueuePass(m_CustomShadowCasterPass);
            ...
            //跟在Transparent队列后进行CopyColor
            if (UniversalRenderPipeline.asset.supportsCameraTransparentOpaqueTexture)
            {
                Downsampling downsamplingMethod = UniversalRenderPipeline.asset.opaqueTransparentDownsampling;
                m_CopyColorPassAfterTrans.Setup(m_ActiveCameraColorAttachment.Identifier(), m_OpaqueAndTransparentColor, downsamplingMethod);
                EnqueuePass(m_CopyColorPassAfterTrans);
            }
