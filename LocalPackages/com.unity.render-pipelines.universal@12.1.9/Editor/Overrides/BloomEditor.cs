...
namespace UnityEditor.Rendering.Universal
{
    ...
    sealed class BloomEditor : VolumeComponentEditor
    {
        ...
        SerializedDataParameter m_SaturationThreshold;
        SerializedDataParameter m_SaturationIntensity;
        ...
        SerializedDataParameter m_bloomFast;
        ...
        public override void OnEnable()
        {
            ...
            m_SaturationThreshold = Unpack(o.Find(x => x.saturationThreshold));
            m_SaturationIntensity = Unpack(o.Find(x => x.saturationIntensity));
            ...
            m_bloomFast = Unpack(o.Find(x => x.bloomFast));
        }
        ...
        public override void OnInspectorGUI()
        {
            ...
            PropertyField(m_SaturationThreshold);
            PropertyField(m_SaturationIntensity);
