...
namespace UnityEditor.Rendering.Universal
{
    internal partial class UniversalRenderPipelineAssetUI
    {
        public static class Styles
        {
            ...
            public static GUIContent requireOpaqueTransparentTextureText = EditorGUIUtility.TrTextContent("OpaqueTransparent Texture", "If enabled the pipeline will copy the screen to texture after Transparents objects are drawn.Modified for SGAME");
            public static GUIContent opaqueTransparentDownsamplingText = EditorGUIUtility.TrTextContent("OpaqueTransparent Downsampling", "The downsampling method that is used for the opaqueTransparent texture");
