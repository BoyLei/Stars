    ...
    internal partial class UniversalRenderPipelineAssetUI
    {
        ...
        static void DrawRendering(SerializedUniversalRenderPipelineAsset serialized, Editor ownerEditor)
        {
            if (ownerEditor is UniversalRenderPipelineAssetEditor urpAssetEditor)
            {
                ...
                EditorGUILayout.PropertyField(serialized.requireOpaqueTransparentTextureProp, Styles.requireOpaqueTransparentTextureText);
                EditorGUI.BeginDisabledGroup(!serialized.requireOpaqueTransparentTextureProp.boolValue);
                EditorGUILayout.PropertyField(serialized.opaqueTransparentDownsamplingProp, Styles.opaqueTransparentDownsamplingText);
                EditorGUI.EndDisabledGroup();
