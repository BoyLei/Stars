    ...
    sealed class BezierShapeEditor : Editor
    {
        ...
        void OnSceneGUI()
        {
            ...
            for (int index = 0; index < count; index++)
            {
                ...
                {
                    prev = point.position;
                    var fmh_541_57_639008904970912018 = Quaternion.identity; prev = Handles.FreeMoveHandle(prev, size, Vector3.zero, Handles.DotHandleCap);
                ...
                if (m_CloseLoop || index > 0)
                {
                    ...
                    else
                    {
                        ...
                        var fmh_574_61_639008904970941248 = Quaternion.identity; prev = Handles.FreeMoveHandle(prev, size, Vector3.zero, Handles.DotHandleCap);
                ...
                if (m_CloseLoop || index < count - 1)
                {
                    ...
                    else
                    {
                        ...
                        var fmh_606_61_639008904970943345 = Quaternion.identity; prev = Handles.FreeMoveHandle(prev, size, Vector3.zero, Handles.DotHandleCap);
