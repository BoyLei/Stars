...
namespace Cinemachine
{
    ...
    public class CinemachineImpulseSource : MonoBehaviour
    {
        ...
        public CinemachineImpulseManager.ImpulseEvent GenerateImpulseAtPositionWithVelocity(Vector3 position, Vector3 velocity)
        {
            if (m_ImpulseDefinition != null)
                return m_ImpulseDefinition.CreateImpulseEvent(position, velocity);
        ...
        /// <param name="velocity">The impact magnitude and direction</param>
        public CinemachineImpulseManager.ImpulseEvent GenerateImpulseWithVelocity(Vector3 velocity)
        {
            return GenerateImpulseAtPositionWithVelocity(transform.position, velocity);
        }
        ...
        public CinemachineImpulseManager.ImpulseEvent GenerateImpulseWithForce(float force)
        {
            return GenerateImpulseAtPositionWithVelocity(
