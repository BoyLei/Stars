...
namespace Cysharp.Threading.Tasks.Internal
{
    internal static class ArrayPoolUtil
    {
        ...
        internal static void EnsureCapacity<T>(ref T[] array, int index, Cysharp.Threading.Tasks.Internal.ArrayPool<T> pool)
        {
        ...
        static void EnsureCapacityCore<T>(ref T[] array, int index, Cysharp.Threading.Tasks.Internal.ArrayPool<T> pool)
        {
            if (array.Length <= index)
            {
        ...
        public static RentArray<T> Materialize<T>(IEnumerable<T> source)
        {
            ...
            if (source is ICollection<T> coll)
            {
                ...
                var pool = Cysharp.Threading.Tasks.Internal.ArrayPool<T>.Shared;
        ...
        public struct RentArray<T> : IDisposable
        {
            ...
            Cysharp.Threading.Tasks.Internal.ArrayPool<T> pool;

            public RentArray(T[] array, int length, Cysharp.Threading.Tasks.Internal.ArrayPool<T> pool)
            {
                this.Array = array;
                this.Length = length;
                this.pool = pool;
