...
namespace SickDev.DevConsole {
    ...
    public class ConsoleInput {
        ...
        float GetClampedButtonSize(float rectHeight, float imageWidth) {
            if(rectHeight<imageWidth)
            {
                if(rectHeight< DevConsole.settings.maxButtonSize)
                {
                    return rectHeight;
                }
                else
                {
                    return DevConsole.settings.maxButtonSize;
                }
            }
            else
            {
                if (imageWidth < DevConsole.settings.maxButtonSize)
                {
                    return imageWidth;
                }
                else
