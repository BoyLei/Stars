...
namespace SickDev.DevConsole
{
    public class DevConsole : MonoBehaviour, ISerializationCallbackReceiver
    {
        ...
        static bool _singletonIsNull = true;
        ...
        public static DevConsole singleton
        {
            get
            {
                ...
                {
                    Instantiate();
                    _singletonIsNull = false;
                }
                return _singleton;
            }
        }

        static bool _settingsIsNull = true;
        ...
        public static Settings settings
        {
            get
            {
                if (_settingsIsNull)
                {
                    ...
                    settingsCopy = Instantiate(_settings);
                    _settingsIsNull = false;
                }
                return _settings;
            }
        }

        bool _commandsManagerIsNull = true;
        CommandsManager _commandsManager;
        public CommandsManager commandsManager
        {
            get
            {
                if (_commandsManagerIsNull)
                {
                    _commandsManager = CreateCommandsManager();

                    _commandsManagerIsNull = false;
                }
