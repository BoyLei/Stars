/*
 * @Description: 编辑器菜单，GameTech开发人员维护，各项目组谨慎修改
 */
...
{
    public class GTCommonMenuWindow : OdinEditorWindow
    {
        /// <summary>
        /// 实现下拉ui
        /// </summary>
        ...
        //子面板
        public GTCommonMenuWindow mychildwindow;
        //选择面板的item索引
        public int selectindex = -1;
        //主面板
        public GTCommonMenuWindow MainWindow = null;
        //显示用到的GUIStyle
        ...
        {
            mychildwindow = new GTCommonMenuWindow();
        ...
        private void SetupSeperator()
        {
            ...
            seperator.normal.background = (Texture2D)GTCommonMenuConfig.menuwhite_tex;
            seperator.hover.background = (Texture2D)GTCommonMenuConfig.menublue_tex;
        ...
        protected override void OnGUI()
        {
            ...
            SirenixEditorGUI.BeginVerticalList();
            {
                ...
                if (MainWindow != null && menuItems != null)
                {
                    ...
                    {
                        MenuItem item = (MenuItem)menuItems[idx];
                        seperator.normal.background = selectindex == idx ? (Texture2D)GTCommonMenuConfig.menublue_tex : (Texture2D)GTCommonMenuConfig.menuwhite_tex;
                        if (ItemIsEnable(idx))
                        {
                            if (rectlist != null)
                            {
                            ...
                            {
                                //多个按钮时给出箭头展开提示
                                GUI.DrawTexture(new Rect(width - 30, idx * itemheight + 8 - linenum * (itemheight / (separator)), 10, 10), GTCommonMenuConfig.menuarrow_tex, ScaleMode.ScaleAndCrop);
                            }
                            if (item.rightlabel != "")
                            {
                        ...
                        else
                        {
                            ...
                            else
                            {
                                ...
                                GUI.DrawTexture(r, GTCommonMenuConfig.menuwhite_tex);
                                seperator.hover.background = (Texture2D)GTCommonMenuConfig.menublue_tex;
                            }
                        }
                    }
