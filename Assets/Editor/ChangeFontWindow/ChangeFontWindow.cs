...
public class ChangeFontWindow : EditorWindow
{
    ...
    private TMP_FontAsset fontAssetToChange;//这个作局部变量使用，用于保护静态变量被随意修改
    private static TMP_FontAsset m_fontAssetToChange;

    private Font fontToChange;//这个作局部变量使用，用于保护静态变量被随意修改
    private static Font m_fontToChange;
    ...
    private void OnGUI()
    {
         ...
         */
        fontAssetToChange = EditorGUILayout.ObjectField(fontAssetToChange, typeof(TMP_FontAsset), true, GUILayout.MinWidth(100f)) as TMP_FontAsset;
        m_fontAssetToChange = fontAssetToChange;

        fontToChange = EditorGUILayout.ObjectField(fontToChange, typeof(Font), true, GUILayout.MinWidth(100f)) as Font;
    ...
    private static void ChangeInCanvas()
    {
        ...
        // 修改输入框的文本
        {
            ...
            foreach (TMP_InputField input in tmpInputs)
            {
                ...
                input.fontAsset = m_fontAssetToChange;
    ...
    private static void ChangeInPrefabs()
    {
        ...
        foreach (GameObject prefab in prefabs)
        {
            // 修改富文本的字体
            {
                TMP_Text[] tmp_Texts = prefab.GetComponentsInChildren<TMP_Text>(true);
            ...
            // 修改输入框的文本
            {
                ...
                //    inputField.fontAsset = m_fontAssetToChange;
