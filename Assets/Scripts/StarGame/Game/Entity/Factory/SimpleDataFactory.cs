...
namespace StarProject.Game.Entity.Factory
{
    ...
    /// 简单数据类的工厂
    /// </summary>
    public static class SimpleDataFactory
    {
        public static bool EnableLog = false;
        private static string LOG_TAG = "SimpleDataFactory";
        ...
        /// @(这里的设计意义)2,应用器: 在使用中的
        /// </summary>
        private static List<SimpleDataObject> m_listObject;
        ...
        public static void Init()
        {
            ...
            m_listObject = new List<SimpleDataObject>();
        ...
        public static T InstanceData<T>() where T : SimpleDataObject, new()
        {
            ...
            //这里取不会错，因为真尾巴才会放在这里
            obj = m_recycler.Pop(type.FullName) as SimpleDataObject;
            if (obj == null)
            {
                //是否是池中物,金鳞?
                useRecycler = false;
        ...
        /// 释放一个实例
        /// </summary>
        /// <param name="entity">SimpleDataObject.</param>
        public static void ReleaseData(SimpleDataObject obj)
        {
            if (obj != null)
            {
                if (EnableLog && Debuger.EnableLog)
        ...
        public static void ClearReleasedObjects()
        {
            ...
            for (int i = m_listObject.Count - 1; i >= 0; i--)
            {
                ...
                {
                    SimpleDataObject obj = m_listObject[i];
