...
using StarProject.Module.BattleZone;
...
{
	public class BattleZoneModule : BusinessModule
	{
		private BattleZoneGame m_game;
        private BattleZoneRoom m_room;
        ...
        private void StartGame(BattleZoneStartParam param)
        {
            //创建游戏逻辑
			m_game = new BattleZoneGame();
            m_game.Start(param);
        ...
        public void StartLocalTest()
        {
			...
			//BattleZoneStartParam param = new BattleZoneStartParam();
