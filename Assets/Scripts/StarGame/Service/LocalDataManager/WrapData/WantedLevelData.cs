//来源表单服副本_Level.xlsm.xlsx -> sheet:WantedLevel
...
{
	[MessagePackObject]
	public class WantedLevelData
	{
		[Key(0)]
		public Dictionary<int, WantedLevelDataCell> StaticWantedLevelDatas = new Dictionary<int, WantedLevelDataCell>();
	}
	[MessagePackObject]
	public class WantedLevelDataCell
	{
		//副本ID
		[Key(0)]
		public int ID;
