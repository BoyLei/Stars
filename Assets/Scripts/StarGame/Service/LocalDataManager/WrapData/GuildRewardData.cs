...
{
	public class GuildRewardData
	{
		public Dictionary<int, GuildRewardDataCell> StaticGuildRewardDatas = new Dictionary<int, GuildRewardDataCell>();
	}
	public class GuildRewardDataCell
	{
		//主Key
		public string Id;
		private int _Id = -1;
