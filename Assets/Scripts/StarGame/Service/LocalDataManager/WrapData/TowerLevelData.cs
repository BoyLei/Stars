//来源表单服副本_Level.xlsm.xlsx -> sheet:TowerLevel
...
namespace StarProjectDef
{
	...
	{
		[Key(0)]
		public Dictionary<int, TowerLevelDataCell> StaticTowerLevelDatas = new Dictionary<int, TowerLevelDataCell>();
	}
	[MessagePackObject]
	public class TowerLevelDataCell
	{
		//副本ID
		[Key(0)]
		public int ID;
