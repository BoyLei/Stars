//来源表单服副本_Level.xlsm.xlsx -> sheet:TeamDailyLevel
...
{
	[MessagePackObject]
	public class TeamDailyLevelData
	{
		[Key(0)]
		public Dictionary<int, TeamDailyLevelDataCell> StaticTeamDailyLevelDatas = new Dictionary<int, TeamDailyLevelDataCell>();
	}
	[MessagePackObject]
	public class TeamDailyLevelDataCell
	{
		//副本ID
		[Key(0)]
		public int ID;
