//来源表单服副本_Level.xlsm.xlsx -> sheet:BFLevel
...
{
	[MessagePackObject]
	public class BFLevelData
	{
		[Key(0)]
		public Dictionary<int, BFLevelDataCell> StaticBFLevelDatas = new Dictionary<int, BFLevelDataCell>();
	}
	[MessagePackObject]
	public class BFLevelDataCell
	{
		//副本ID
		[Key(0)]
		public int ID;
