//来源表单服副本_Level.xlsm.xlsx -> sheet:DailyLevel
...
namespace StarProjectDef
{
	...
	{
		[Key(0)]
		public Dictionary<int, DailyLevelDataCell> StaticDailyLevelDatas = new Dictionary<int, DailyLevelDataCell>();
	}
	[MessagePackObject]
	public class DailyLevelDataCell
	{
		//副本ID
		[Key(0)]
		public int ID;
