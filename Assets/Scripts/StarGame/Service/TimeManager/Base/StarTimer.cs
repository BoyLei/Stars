...
namespace StarProject.Service.Time.Base
{
    ...
    public class StarTimer
    {
        ...
        public StarTimer(float totalTime, bool isDestroy = true, bool isPause = false)
        {
            curtime = 0;
