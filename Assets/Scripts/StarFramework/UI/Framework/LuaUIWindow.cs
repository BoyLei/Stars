...
{
    public class LuaUIWindow : UIWindow
    {
        [LabelText("Lua路径")]
        ...
        private void InitLuaEnv()
        {
            ...
            //var luaText = ResourceFormalManager.Instance.LoadLuaAssetAsync(LuaFilePath);
            //var textasset = StarProject.Service.Resource.ResourceFormalManager.Instance.LoadConfigSync<UnityEngine.TextAsset>(LuaFilePath);
            ...
            //tb.Set("Close", this.CloseAction);
            //tb.Set("PlayAnimation", PlayAnimationAction);
            //tb.Set("ForcePlayAnimation", ForcePlayAnimationAction);
