...
{
    public class DUI3DWorld : MonoBehaviour
    {
        public const string LOG_TAG = "DUI3DWorld";
        private static GameObject _root;
        private static string _UI3DWorld = "DUI_3D_World";
        ...
        public static GameObject FindUI3DRoot()
        {
            ...
            if (root != null && root.GetComponent<DUI3DWorld>() != null)
            {
                return root;
            }
            return null;
