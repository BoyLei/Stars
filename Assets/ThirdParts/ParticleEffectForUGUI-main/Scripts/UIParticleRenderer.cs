...
namespace Coffee.UIExtensions
{
    ...
    internal class UIParticleRenderer : MaskableGraphic
    {
        ...
        public override Material GetModifiedMaterial(Material baseMaterial)
        {
            ...
            if (texture == null)
            {
                texture = baseMaterial.mainTexture;
            }
            ...
            modifiedMaterial = ModifiedMaterial.Add(modifiedMaterial, texture, id);
             ModifiedMaterial.Remove(_modifiedMaterial);
            //从缓存中重新赋值MainTex和相关参数
             modifiedMaterial.mainTextureOffset = baseMaterial.mainTextureOffset;
             modifiedMaterial.mainTextureScale = baseMaterial.mainTextureScale;
