...
namespace Yoka.UnityString.Examples
{
    public class ExampleTest : MonoBehaviour
    {
        ...
        private string str1 = "222Assets/";
        private string str2 = "/solider我的222.prefab";

        private string str3 = "111Assets/";
        private string str4 = "/solider111.prefab";

        private string str5 = "   中国    的 ";

        private string str6 = "aaatbbscctdd";
        private string str7 = "222tsse{0}ts{0}//As{1}/As{2}/xcv";
        private char[] splitChars = new char[] { 't', 's' };

        private List<string> strs = new List<string> { "aaa", "bbb", "ccc" };
