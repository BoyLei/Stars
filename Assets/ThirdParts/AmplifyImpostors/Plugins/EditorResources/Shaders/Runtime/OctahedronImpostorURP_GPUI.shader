...
Shader "GPUInstancer/Hidden/Amplify Impostors/Octahedron Impostor URP"
{
	Properties
	{
	...
	SubShader
	{
		Tags { "RenderPipeline" = "UniversalPipeline" "RenderType" = "Opaque" "Queue" = "Geometry+200" "DisableBatching" = "True" }
