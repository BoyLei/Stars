...
namespace CSObjectWrapEditor
{
    ...
    public static class Generator
    {
        ...
        static void getClassInfo(Type type, LuaTable parameters)
        {
            ...
            List<string> extension_methods_namespace = new();
            ...
            List<LazyMemberInfo> lazyMemberInfos = new();
        ...
        static void GenEnumWrap(IEnumerable<Type> types, string save_path)
        {
            ...
            StreamWriter textWriter = new(filePath, false, Encoding.UTF8);
        ...
        static MethodInfoSimulation makeMethodInfoSimulation(MethodInfo method)
        {
            ...
            List<ParameterInfoSimulation> paramsExpect = new();
        ...
        public static List<Type> CSharpCallLua = new() {
                ...
                typeof(UnityAction<int, string,string>),
                typeof(UnityAction<int, int, string, string>),
        ...
        public static List<string> assemblyList = new() {
            "System.dll",
        };
