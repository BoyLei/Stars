...
namespace GPUInstancer
{
    public static class GPUInstancerUtility
    {
        ...
        {
            if (runtimeData == null || runtimeData.instanceLODs == null || runtimeData.prototype == null || runtimeData.instanceLODDataBuffer == null || runtimeData.transformationMatrixVisibilityBuffer == null
               || runtimeData.instanceBounds == null || runtimeData.hasShadowCasterBuffer == null)
            {
                return;
            }
            ...
            foreach (GPUInstancerPrototypeLOD gpuiLod in runtimeData.instanceLODs)
            {
                ...
                if (gpuiLod.transformationMatrixAppendTexture == null || gpuiLod.transformationMatrixAppendTexture.width != runtimeData.bufferSize)
                {
                    ...
                    {
                        gpuiLod.transformationMatrixAppendTexture.name = "_gpui_matrix_lod" + lod;
                    }
                    gpuiLod.transformationMatrixAppendTexture.Create();
                }

                if (/*runtimeData.hasShadowCasterBuffer*/false) //modify by lijun08
                {
                    if (gpuiLod.shadowAppendBuffer != null)
                        gpuiLod.shadowAppendBuffer.Release();
                    gpuiLod.shadowAppendBuffer = new ComputeBuffer(runtimeData.bufferSize, GPUInstancerConstants.STRIDE_SIZE_INT, ComputeBufferType.Append);
                    ...
                    if (Debug.isDebugBuild)
                    {
                        gpuiLod.shadowAppendTexture.name = "_gpui_shadow_lod" + lod;
                    }
                ...
                {
                    // Setup instance LOD renderer material property block shader buffers with the append buffer
                    if (gpuiLod.transformationMatrixAppendTexture != null)
                    {
                        ...
                        if (runtimeData.prototype.isLODCrossFade)
                        {
                            ...
                            {
                                if (runtimeData.instanceLODDataTexture != null)
                                {
                                    renderer.mpb.SetFloat(GPUInstancerConstants.VisibilityKernelPoperties.BUFFER_PARAMETER_FADE_LEVEL_MULTIPLIER, 1);
                        ...
                        if (runtimeData.hasShadowCasterBuffer)
                        {
                            if (gpuiLod.shadowAppendTexture != null)
                            {
            ...
            where T : GPUInstancerRuntimeData
        {
            ...
            for (int i = 0; i < runtimeDataList.Count; i++)
            {
                if (runtimeDataList[i] == null || runtimeDataList[i].instanceLODs == null || runtimeDataList[i].prototype == null || runtimeDataList[i].instanceLODDataBuffer == null || runtimeDataList[i].transformationMatrixVisibilityBuffer == null
               || runtimeDataList[i].instanceBounds == null || runtimeDataList[i].hasShadowCasterBuffer == null)
                { return; }
                else
                {
        ...
        {
            if (visibilityComputeShader == null || runtimeData == null || runtimeData.instanceLODs == null)
            {
                return;
            }
            ...
            for (int lod = 0; lod < lodCount - lodShift && lod < GPUInstancerConstants.COMPUTE_MAX_LOD_BUFFER; lod++)
            {
                ...
                if (rdLOD != null)
                {
                    if (isShadow)
                    {
                        if (rdLOD.shadowAppendBuffer != null)
                        {
                    ...
                    {
                        if (rdLOD.transformationMatrixAppendBuffer != null) 
                        {
                            if (lodAppendIndex == 0)
        ...
        public static void DispatchBufferToTexture<T>(List<T> runtimeDataList, ComputeShader bufferToTextureComputeShader, int bufferToTextureComputeKernelID, int bufferToTextureCrossFadeKernelID = 1) where T : GPUInstancerRuntimeData
        {
            ...
            foreach (T runtimeData in runtimeDataList)
            {
                ...
                for (int lod = 0; lod < runtimeData.instanceLODs.Count; lod++)
                {
                    ...
                    {
                        //Debug.LogWarning("runtimeData.transformationMatrixVisibilityBuffer is null");
                    }
                    ...
                    {
                        //Debug.LogWarning($"runtimeData.instanceLODs{lod}.transformationMatrixAppendBuffer is null"); 
                    }
                    ...
                    {
                        //Debug.LogWarning($"SetTexture runtimeData.instanceLODs{lod}.transformationMatrixAppendTexture is null");
                    }
                    ...
                    {
                        //Debug.LogWarning("runtimeData.argsBuffer is null");
                    }
                    ...
                    if (runtimeData.hasShadowCasterBuffer)
                    {
                        ...
                        {
                            //Debug.LogWarning("runtimeData.hasShadowCasterBuffer runtimeData.transformationMatrixVisibilityBuffer is null");
                        }
                        ...
                        {
                            //Debug.LogWarning($"runtimeData.hasShadowCasterBuffer runtimeData.instanceLODs{lod}.shadowAppendBuffer is null");
                        }
                        ...
                        {
                            //Debug.LogWarning($"runtimeData.hasShadowCasterBuffer SetTexture runtimeData.instanceLODs{lod}.shadowAppendTexture is null");
                        }
                        ...
                        {
                            //Debug.LogWarning("runtimeData.hasShadowCasterBuffer runtimeData.shadowArgsBuffer is null");
                        }
                        bufferToTextureComputeShader.SetInt(GPUInstancerConstants.VisibilityKernelPoperties.ARGS_BUFFER_INDEX, runtimeData.instanceLODs[lod].argsBufferOffset + 1);
                        bufferToTextureComputeShader.SetInt(GPUInstancerConstants.VisibilityKernelPoperties.MAX_TEXTURE_SIZE, GPUInstancerConstants.TEXTURE_MAX_SIZE);
                    ...
                    if (runtimeData.prototype.isLODCrossFade)
                    {
                        ...
                        {
                            //Debug.LogWarning($"runtimeData.prototype.isLODCrossFade SetTexture runtimeData.instanceLODDataTexture is null");
                        }
                        if (runtimeData.instanceLODDataBuffer != null)
                        {
                        ...
                        {
                            //Debug.LogWarning("runtimeData.prototype.isLODCrossFade runtimeData.instanceLODDataBuffer is null");
                        }
        ...
        private static Texture2D CreateTextureFilledWithColor(Color color)
        {
            ...
            try
            {
                ...
                for (int i = 0; i < sampleChildrenMRs.Length; i++)
                {
                    ...
                    for (int m = 0; m < sampleChildrenMRs[i].sharedMaterials.Length; m++)
                    {
                        ...
                        else if (sampleChildrenMRs[i].sharedMaterials[m].HasProperty("_BaseMap"))
                        {
                            sampleChildrenMRs[i].sharedMaterials[m].SetTexture("_MainTex", sampleChildrenMRs[i].sharedMaterials[m].GetTexture("_BaseMap"));
                        }


                        else if (sampleChildrenMRs[i].sharedMaterials[m].HasProperty("_BaseColor"))
                        {
                            Color baseColor = sampleChildrenMRs[i].sharedMaterials[m].GetColor("_BaseColor");
                            Texture2D baseColorTexture = CreateTextureFilledWithColor(baseColor);
                            sampleChildrenMRs[i].sharedMaterials[m].SetTexture("_MainTex", baseColorTexture);
                        }


                        else if (sampleChildrenMRs[i].sharedMaterials[m].HasProperty("_LightSideColorA"))
                        {
                            Color baseColor = sampleChildrenMRs[i].sharedMaterials[m].GetColor("_LightSideColorA");
                            Texture2D baseColorTexture = CreateTextureFilledWithColor(baseColor);
                            sampleChildrenMRs[i].sharedMaterials[m].SetTexture("_MainTex", baseColorTexture);
                        }
        ...
        public static void SetShadowCaster(GPUInstancerRuntimeData runtimeData)
        {
            if (runtimeData == null || runtimeData.transformationMatrixVisibilityBuffer == null || runtimeData.bufferSize == 0 || runtimeData.instanceCount == 0)
                return;
            ...
            for (int lod = 0; lod < runtimeData.instanceLODs.Count; lod++)
            {
                ...
                for (int r = 0; r < rdLOD.renderers.Count; r++)
                {
                    ...
                    for (int m = 0; m < rdRenderer.materials.Count; m++)
                    {
                        ...
                        if (!rdRenderer.castShadows)
                        {
                            rdMaterial.SetShaderPassEnabled("ShadowCaster", false);
                        }
                    }
                }
            }
