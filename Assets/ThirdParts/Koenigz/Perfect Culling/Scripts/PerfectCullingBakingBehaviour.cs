...
namespace Koenigz.PerfectCulling
{
    ...
    public abstract class PerfectCullingBakingBehaviour : MonoBehaviour
    {
        ...
        public bool SamplingProvidersIsPositionActive(Vector3 pos, Vector3 extents)
        {
            ...
            {
                if (!provider.IsSamplingPositionActive(this, pos, extents))
                {
                    return false;
                }
            }
        ...
        public IEnumerator PerformBakeAsync(bool sceneReload, bool saveScene, HashSet<Renderer> additionalOccludersHashset)
        {
            ...
            try
            {
                ...
                for (int i = 0; i < worldPositions.Count; ++i)
                {
                    ...
                    bool active = SamplingProvidersIsPositionActive(worldPositions[i], GetCellSize());
        ...
        public virtual Vector3 GetCellSize() => throw new System.NotImplementedException();
    }
}