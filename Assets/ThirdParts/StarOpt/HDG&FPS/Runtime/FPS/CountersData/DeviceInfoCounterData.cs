	...
	public class DeviceInfoCounterData: BaseCounterData
	{
		...
		internal override void UpdateValue(bool force)
		{
			...
			if (gpuApi)
			{
				...
				text.Append("GPU INSTANCE: ");
				text.Append(SystemInfo.supportsInstancing);
				text.Append(" MRT CNT: ");
				text.Append(SystemInfo.supportedRenderTargetCount);
				text.Append(" ComputeShader: ");
				text.Append(SystemInfo.supportsComputeShaders);
				hasContent = true;
			}
