		...
		private void ThreadFunc()
		{
			while (m_run)
			{
				...
				catch (SocketException e)
				{
					...
					rdtDebug.Error(this, e, "Couldn't broadcast hello message: {0}", ex.Message);
					break;
				}
				catch (Exception e2)
				{
					Exception ex2 = (e2.InnerException != null) ? e2.InnerException : e2;
					rdtDebug.Error(this, e2, "Error broadcasting hello message: {0}", ex2.Message);
				}
				Thread.Sleep(Settings.BROADCAST_TIME);
			}
