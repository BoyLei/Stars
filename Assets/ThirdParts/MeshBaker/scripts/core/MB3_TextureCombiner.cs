...
//			new ShaderTextureProperty("_DetailNormalMap",true),
			...
			new ShaderTextureProperty("_NormalTex", true),
			new ShaderTextureProperty("_MRAETex", false),
			new ShaderTextureProperty("_DetailTex", false),
		};
