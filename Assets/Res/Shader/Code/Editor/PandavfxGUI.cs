...
public class PandavfxGUI : ShaderGUI
{
    ...
    static bool _Save_Material = false;
 ...
 //   MaterialProperty MainAlphaPower = null;
    ...
    public override void OnGUI(MaterialEditor materialEditor, MaterialProperty[] props)
    {
        ...
        //保存材质
        EditorGUILayout.BeginVertical(EditorStyles.helpBox);
        _Save_Material = Foldout(_Save_Material, "保存材质(SaveMaterial)");
...
//
       EditorGUILayout.BeginVertical(EditorStyles.helpBox);
        ...
        float screenAsMain = material.GetFloat(ScreenAsMain.name);
        if (screenAsMain == 1)
        {
            material.EnableKeyword("_GRAB_TEX");
        }
        else
        {
            material.DisableKeyword("_GRAB_TEX");
        }
        ...
        if (Dissolve_Tex.textureValue != null)
        {
         ...
         //   GUILayout.Space(5);
            ...
            if (material.GetFloat("_IfDissolvePlus") == 1)
            {
                ...
                {
                    material.EnableKeyword("_DISSOLVE_TEX_PLUS");
                    EditorGUILayout.BeginVertical(EditorStyles.helpBox);
                ...
                {
                    material.DisableKeyword("_DISSOLVE_TEX_PLUS");
                    material.SetFloat("_DissolveTexDivide",1);
                }
...

    {
        ...
        {
            material.EnableKeyword("_VTOMASK_TEX");
        ...
        {
            material.DisableKeyword("_VTOMASK_TEX");
        }
   ...
   // 
    ...
    void GUI_Save(Material material)
    {
        ...
        EditorGUILayout.PrefixLabel("保存材质");


        if (GUILayout.Button("保存", shortButtonStyle))
        {
            int ver = material.GetInt("_Version");
            material.SetInt("_Version", ver+1);
