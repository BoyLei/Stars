...
Shader "Universal Render Pipeline/FX/Stylized Water 2"
{
	Properties
	{
		...
		[MaterialEnum(Camera Depth,0)] _IntersectionSource("Intersection source", Float) = 0
		...
		_ReflectionRange("Reflection range",Range(0,1)) = 0.3
...
//			#include "Libraries/Tesselation.hlsl"
			...
			#include "Libraries/ForwardPassSimple.hlsl"
...
//
//
//            TEXTURE2D(_GlobalDownScaledTransparents);
//            SAMPLER(sampler_GlobalDownScaledTransparents);
//
//            struct Attributes
//            {
...
//            	
//                return SAMPLE_TEXTURE2D(_GlobalDownScaledTransparents, sampler_GlobalDownScaledTransparents, screen_uv);
//            }
//            ENDHLSL
//        }
//
