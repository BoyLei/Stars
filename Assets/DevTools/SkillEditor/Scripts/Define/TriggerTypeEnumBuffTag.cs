...
namespace SkillEditor
{
    ...
    public  class TriggerTypeEnumBuffTag:TriggerTypeEnumBaseData 
    {
        /// <summary>
        /// 检查对象
        /// <summary>
        ...
        /// <summary>
        [LabelText("BuffTag")]
        [ValueDropdown("_value")]
        public BuffLabel Value= new BuffLabel();
