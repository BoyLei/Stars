...
namespace BattleDebug
{
    public class BattleSkillDebug
    {
        ...
        public string SkillUniqueID { get; private set; }
        ...
        public BattleSkillDebug(int skillID,string UID)
        {
            SkillID = skillID;
            SkillUniqueID = UID;
            Stages = new Dictionary<string, StageDebug>();
        ...
        public void OnModify(StageEnum stage, DebugData debugData)
        {
            ...
            if (debugData.IsStart)
            {
                ...
                Stages[debugData.UniqueID].EndTime = Stages[debugData.UniqueID].StarTime + 0.02f;
