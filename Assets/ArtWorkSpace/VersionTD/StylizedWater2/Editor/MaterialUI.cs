...
namespace StylizedWater2
{
    public class MaterialUI : ShaderGUI
    {
        ...
        private MaterialProperty _ReflectionRange;
        ...
        public void FindProperties(MaterialProperty[] props)
        {
            ...
            _ReflectionRange = FindProperty("_ReflectionRange", props);
        ...
        private void DrawReflections()
        {
            ...
            if (EditorGUILayout.BeginFadeGroup(reflectionSection.anim.faded))
            {
                ...
                if (enableEnvReflections)
                {
                    ...
                    materialEditor.ShaderProperty(_ReflectionRange, new GUIContent(_ReflectionRange.displayName, "Masks the reflection by the viewing angle in relationship to the surface (including wave curvature), which is more true to nature (known as fresnel)"));
